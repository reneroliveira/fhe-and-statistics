...
Take a function $f\in\mathcal P$ in the plaintext space, and some elements $s_1,s_2,\ldots\in S$. Rewriting \ref{privhom} in this new notation we get the correctness property for $f$:
\begin{align*}
