...
\begin{align*}
    ...
    \varphi(1_R)&=1_S
\end{align*}
Similarly, we can define group homomorphisms that will preserve their unique underlying operation. $\varphi(0_R)=0_S$ is a consequence of group properties \cite{omn}.
\end{definition}
...
Since a ring $R$ can be viewed as an additive abelian group and an ideal $I\subseteq R$ as a subgroup. We
